...
public class CaffeineListActivity extends AppCompatActivity
    ...
    public static final int COARSE_LOCATION_REQUEST_CODE = 111;
    private DBHelper db;
    ...
    //Google API client is fuesd services for all apps on the device (location, maps, play store
    private GoogleApiClient mGoogleApiClient;
    //Last lattitute and longitude reported
    private Location mLastLocation;
    //Location requests are made every X seconds (we configure)
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            //Don't have Coarse or Fine location so request them:
    ...
    public void findClosestCaffeine(View v)
    {
        ...
        {
            //convert CaffeineLocation into a google Location
